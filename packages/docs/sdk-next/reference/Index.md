...
| [setConfig](functions/setConfig.md) | Configures the SDK for the site this request is being served as. |
...
| [ContentEntries](type-aliases/ContentEntries.md) | One entry per node type, on a single map. |
| [ContentStyles](type-aliases/ContentStyles.md) | The class names a caller may set, one per thing the renderer puts a class on. |
...
| [ResolvedListing](type-aliases/ResolvedListing.md) | What a listing component is handed: the block's records, plus the site. |
