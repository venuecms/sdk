...
Defined in: packages/sdk-next/src/utils/content.ts:31
...
| ------ | ------ | ------ |
| <a id="content"></a> `content` | [`LocalizedContent`](../type-aliases/LocalizedContent.md) | packages/sdk-next/src/utils/content.ts:34 |
| <a id="currentlocale"></a> `currentLocale` | `string` | packages/sdk-next/src/utils/content.ts:34 |
